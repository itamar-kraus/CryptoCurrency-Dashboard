  ...
  return (
    <div className="tab-content font boldtext-gray-800 dark:text-white">
      <div id="contact-header">
        <h1 className="sm:text-6xl center-align text-3xl font-bold mb-9 bg-gradient-to-r from-blue-600 via-pink-700 to-indigo-400 inline-block text-transparent bg-clip-text">
          GET IN TOUCH
        </h1>
      </div>
      ...
      <div class="flex flex-col items-end gap-6 w-96 ml-2">
        <form onSubmit={handleSubmit} class="w-full">
          ...
          <button
            ...
            class="px-4 py-2 rounded transition-all hover:bg-blue-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-gray-400 focus:ring-opacity-50"
          >
            Send Message
          </button>
        </form>
