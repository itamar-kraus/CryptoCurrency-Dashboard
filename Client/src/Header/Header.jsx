...
export const Header = () => {
  ...
  return (
    <div
      id="header"
      className="bg-[radial-gradient(circle_at_bottom_left,_var(--tw-gradient-stops))] from-zinc-900 via-slate-900 to-zinc-900 text-white p-4 flex justify-between items-center"
    >
